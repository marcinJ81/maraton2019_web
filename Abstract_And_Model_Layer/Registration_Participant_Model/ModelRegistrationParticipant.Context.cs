...
namespace Abstract_And_Model_Layer.Registration_Participant_Model
{
    ...
    public partial class EntitiesRegistrationParticipant : DbContext
    {
        public EntitiesRegistrationParticipant()
            : base("name=EntitiesRegistrationParticipant")
        {
        }
        ...
        public virtual DbSet<modelExt> modelExt { get; set; }
        public virtual DbSet<VmodelExt> VmodelExt { get; set; }
        public virtual DbSet<VOneColumn> VOneColumn { get; set; }
